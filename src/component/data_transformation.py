...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            test_df = test_df[(test_df.depth < 75) & (test_df.depth > 45)]
            test_df = test_df[(test_df.table < 80) & (test_df.table > 40)]
            test_df = test_df[(test_df.x < 30)]
            test_df = test_df[(test_df.y < 30)]
            test_df = test_df[(test_df.z < 30) & (test_df.z > 2)]
